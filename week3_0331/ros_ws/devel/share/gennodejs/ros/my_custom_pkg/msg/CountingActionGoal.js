...
let CountingGoal = require('./CountingGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CountingActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CountingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CountingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CountingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CountingGoal()
    }
...
module.exports = CountingActionGoal;
